...
cp ./Info.plist SalveTest.app/Contents
...
for SIZE in 16 32 64 128 256 512; do
    sips -z $SIZE $SIZE ./icon.png --out SalveTest.app/Contents/Resources/AppIcon.iconset/icon_${SIZE}x${SIZE}.png || exit 1
done

# Retina display icons
for SIZE in 32 64 256 512; do
    sips -z $SIZE $SIZE ./icon.png --out SalveTest.app/Contents/Resources/AppIcon.iconset/icon_$(expr $SIZE / 2)x$(expr $SIZE / 2)x2.png || exit 1
done
